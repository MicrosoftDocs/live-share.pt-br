...
O Live Share permite que você edite e depure de forma colaborativa com outras pessoas em tempo real, sejam quais forem as linguagens de programação usadas ou os tipos de aplicativo criados. Ele permite que você instantaneamente (e com segurança) compartilhar seu projeto atual e em seguida, conforme necessário, compartilhar sessões de depuração, instâncias de terminal, aplicativos web do localhost e muito mais! Os desenvolvedores que unem as sessões de recebem todas as sua contexto do editor do seu ambiente (por exemplo, serviços de linguagem, depuração), que garante que eles podem começar a colaborar produtiva imediatamente, sem a necessidade de clonar qualquer repositórios ou instalar todos os SDKs.
...
Compartilhamento ao vivo agora está disponível! Você pode [Introdução ao Live Share](https://aka.ms/vsls-start) hoje mesmo.
...
## <a name="which-languages-and-platforms-will-be-supported"></a>Quais linguagens e plataformas terão suporte?
